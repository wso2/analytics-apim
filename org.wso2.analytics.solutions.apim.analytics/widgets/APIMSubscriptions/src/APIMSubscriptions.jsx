 ...
 * @class APIMSubscriptions
 * @extends {Widget}
 */
class APIMSubscriptions extends Widget {
    /**
     * Creates an instance of APIMSubscriptions.
     * @param {any} props @inheritDoc
     * @memberof APIMSubscriptions
     */
    constructor(props) {
        super(props);
...
global.dashboard.registerWidget('APIMSubscriptions', APIMSubscriptions);
