 ...
 * @class APIMAppCreated
 * @extends {Widget}
 */
class APIMAppCreated extends Widget {
    /**
     * Creates an instance of APIMAppCreated.
     * @param {any} props @inheritDoc
     * @memberof APIMAppCreated
     */
    constructor(props) {
        super(props);
                    ...
                    <IntlProvider locale={languageWithoutRegionCode} messages={localeMessages}>
                        ...
                        >
                            ...
                            <button
                                ...
                                onClick={() => {
                                    window.location.href = './APP-Created-Analysis';
                                }}
                            >
...
global.dashboard.registerWidget('APIMAppCreated', APIMAppCreated);
