...
class APIMTopPlatformsWidget extends Widget {
    ...
    render() {
        const {
            localeMessages, faultyProviderConfig, height, limit, apiCreatedBy, apiSelected, apiVersion, legendData, platformData, apilist, versionlist,
        } = this.state;
                                ...
                                >
                                    ...
                                    <Typography component='p'>
                                        <FormattedMessage
                                            ...
                                            defaultMessage='Cannot fetch provider configuration for APIM Top Platforms widget'
                                        />
                                    </Typography>
                                </Paper>
                            </div>
