 ...
 * @class APIMApiCreated
 * @extends {Widget}
 */
class APIMApiCreated extends Widget {
    /**
     * Creates an instance of APIMApiCreated.
     * @param {any} props @inheritDoc
     * @memberof APIMApiCreated
     */
    constructor(props) {
        super(props);
...
global.dashboard.registerWidget('APIMApiCreated', APIMApiCreated);
