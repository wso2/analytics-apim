...
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }(); /*eslint no-magic-numbers: ["error", { "ignore": [-1, 0, 1, 2, 1000] }]*/
...
var Helpers = {
  ...
  getDomain: function (props) {
    ...
    if (childComponents.length) {
      childrenDomain = dimension ? _defineProperty({}, dimension, _wrapper2.default.getDomainFromChildren(props, dimension, childComponents)) : {
  ...
  onWheel: function (evt, targetProps, eventKey, ctx) {
    ...
    var onDomainChange = targetProps.onDomainChange,
        dimension = targetProps.dimension,
        zoomDomain = targetProps.zoomDomain;
    ...
    || targetProps.zoomActive && !(0, _isEqual3.default)(originalDomain, lastDomain);
...
exports.RawZoomHelpers = Helpers; // allow victory-native to extend these helpers
