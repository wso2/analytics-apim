...
var getRowHeights = function (props, data) {
  ...
  return (0, _keys3.default)(dataByRow).reduce(function (memo, curr, index) {
    ...
    var lengths = rows.map(function (d) {
      return d.textSize.height + d.symbolSpacer;
    });
    memo[index] = Math.max.apply(Math, _toConsumableArray(lengths));
    return memo;
  }, []);
...
var getBorderProps = function (props, contentHeight, contentWidth) {
  ...
  return { x: x, y: y, height: height, width: width, style: style.border };
};

exports.default = function (props, fallbackProps) {
  ...
  var _props = props,
      ...
      borderPadding = _props.borderPadding,
      title = _props.title,
  ...
  var contentHeight = titleOrientation === "left" || titleOrientation === "right" ? Math.max((0, _sum3.default)(rowHeights), titleDimensions.height) : (0, _sum3.default)(rowHeights) + titleDimensions.height;
  var contentWidth = titleOrientation === "left" || titleOrientation === "right" ? (0, _sum3.default)(columnWidths) + titleDimensions.width : Math.max((0, _sum3.default)(columnWidths), titleDimensions.width);
  ...
  var borderProps = getBorderProps(props, contentHeight, contentWidth);
