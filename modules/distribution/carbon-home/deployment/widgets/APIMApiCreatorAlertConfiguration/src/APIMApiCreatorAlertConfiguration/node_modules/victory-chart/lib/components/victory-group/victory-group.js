  ...
  _createClass(VictoryGroup, [{
    ...
    value: function getDataWithOffset(props, defaultDataset, offset) {
      ...
      return dataset.map(function (datum) {
        var _x1 = datum._x instanceof Date ? new Date(datum._x + xOffset) : datum._x + xOffset;
    ...
    value: function render() {
      ...
      return standalone ? _react2.default.cloneElement(container, container.props, newChildren) : _react2.default.cloneElement(groupComponent, {}, newChildren);
    }
  }]);
