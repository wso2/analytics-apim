...
var VictoryLabel = function (_React$Component) {
  ...
  _createClass(VictoryLabel, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      if (!Collection.allSetsEqual([[active, nextProps.active], [angle, nextProps.angle], [className, nextProps.className], [x, nextProps.x], [y, nextProps.y], [dx, this.dx], [dy, this.dy], [lineHeight, this.lineHeight], [textAnchor, this.textAnchor], [transform, this.transform], [content, this.content], [style, this.style], [datum, nextProps.datum]])) {
    ...
    value: function calculateAttributes(props) {
      ...
      var textAnchor = props.textAnchor ? Helpers.evaluateProp(props.textAnchor, props.datum) : "start";
      var content = this.getContent(props);
      var dx = props.dx ? Helpers.evaluateProp(this.props.dx, props.datum) : 0;
    ...
    value: function getStyle(props, style) {
      style = style ? _merge({}, defaultStyles, style) : defaultStyles;
    ...
    value: function getDy(props, style, content, lineHeight) {
      ...
      var datum = props.datum || props.data;
      var dy = props.dy ? Helpers.evaluateProp(props.dy, datum) : 0;
    ...
    value: function getTransform(props, style) {
      ...
      var transformPart = transform && Helpers.evaluateProp(transform, datum);
    ...
    value: function renderElements(props) {
      ...
      return React.createElement(
        ...
        this.props.desc && React.createElement(
          "desc",
          null,
          this.props.desc
        ),
...
VictoryLabel.propTypes = {
  ...
  lineHeight: PropTypes.oneOfType([PropTypes.string, CustomPropTypes.nonNegative, PropTypes.func]),
