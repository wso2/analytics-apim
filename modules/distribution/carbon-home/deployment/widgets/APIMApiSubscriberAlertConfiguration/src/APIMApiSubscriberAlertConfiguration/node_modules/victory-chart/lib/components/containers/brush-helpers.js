...
var Helpers = {
  ...
  getDomainBox: function (props, fullDomain, selectedDomain) {
    ...
    var fullCoordinates = _victoryCore.Selection.getDomainCoordinates(props, fullDomain);
    var selectedCoordinates = _victoryCore.Selection.getDomainCoordinates(props, selectedDomain);
  ...
  onMouseDown: function (evt, targetProps) {
    ...
    var currentDomain = (0, _isEqual3.default)(selectedDomain, cachedSelectedDomain) ? targetProps.currentDomain || selectedDomain || domain : selectedDomain || domain;
    ...
    if (activeHandles) {
      ...
      if ((0, _isFunction3.default)(onDomainChange)) {
        onDomainChange(minimumDomain, (0, _defaults3.default)({}, mutatedProps, targetProps));
      }
      return [{
        target: "parent",
        mutation: function () {
  ...
  onMouseMove: function (evt, targetProps) {
    ...
    if (isPanning) {
      ...
      if ((0, _isFunction3.default)(onDomainChange)) {
        onDomainChange(currentDomain, (0, _defaults3.default)({}, mutatedProps, targetProps));
      }
      return [{
        target: "parent",
        mutation: function () {
      ...
      if ((0, _isFunction3.default)(onDomainChange)) {
        onDomainChange(_currentDomain, (0, _defaults3.default)({}, _mutatedProps, targetProps));
      }
      return [{
        target: "parent",
        mutation: function () {
  ...
  onMouseUp: function (evt, targetProps) {
    ...
    if (x1 === x2 || y1 === y2) {
      ...
      if ((0, _isFunction3.default)(onDomainChange)) {
        onDomainChange(domain, (0, _defaults3.default)({}, mutatedProps, targetProps));
      }
      return [{
        target: "parent",
        mutation: function () {
