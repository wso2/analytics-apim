...
public class FileBasedAnalyticsRestAPITest {
    ...
    public void getUpdatedApis() throws Exception {
        ...
        FileBasedAnalyticsRestAPI microGwAPI = new FileBasedAnalyticsRestAPI();
    ...
    public void uploadFile() throws Exception {
        ...
        PowerMockito.doNothing()
                .when(UploadedUsageFileInfoDAO.class, "persistUploadedFile", any(UploadedFileInfoDTO.class),
    ...
    public void getUpdatedApis_UnauthorizedUser() throws Exception {
        ...
        FileBasedAnalyticsRestAPI lifeCyclePubServ = new FileBasedAnalyticsRestAPI();
        HttpHeaders httpHeaders = Mockito.mock(HttpHeaders.class);
