...
package org.wso2.analytics.apim.file.impl.config;
...
public class ConfigManager {
    ...
    private ConfigManager() throws FileBasedAnalyticsException {
        init();
    }
     ...
     */
    public static ConfigManager getConfigManager() throws FileBasedAnalyticsException {
     ...
     *
     */
    private void init() throws FileBasedAnalyticsException {
        configProperties = new Properties();
        String filePath = CarbonUtils.getCarbonConfigDirPath() + File.separator +
                FileBasedAnalyticsConstants.CONFIG_FILE_NAME;
        try (InputStream inputStream = new FileInputStream(filePath)) {
            ...
            String errorMessage = "Error occurred while reading the config file : "
                    + FileBasedAnalyticsConstants.CONFIG_FILE_NAME;
            throw new FileBasedAnalyticsException(errorMessage, ex);
        }
    }
