...
public class FileBasedAnalyticsDBUtil {

    private static final Log log = LogFactory.getLog(FileBasedAnalyticsDBUtil.class);

    private static volatile DataSource dataSource = null;
    private static final String DATA_SOURCE_NAME = "jdbc/WSO2AM_FILE_ANALYTICS_DB";
    ...
    public static void initialize() {
        ...
        synchronized (FileBasedAnalyticsDBUtil.class) {
            if (dataSource == null) {
