...
package org.wso2.analytics.apim.file.impl.dao;
...
import org.wso2.analytics.apim.file.impl.util.FileBasedAnalyticsDBUtil;
 ...
 */
public class FileBasedAnalyticsDAO {

    private static final Log log = LogFactory.getLog(FileBasedAnalyticsDAO.class);

    static {
        FileBasedAnalyticsDBUtil.initialize();
    }
    ...
    public static void persistUploadedFile(UploadedFileInfoDTO dto, InputStream uploadedInputStream)
        ...
        try {
            connection = FileBasedAnalyticsDBUtil.getConnection();
            autoCommitStatus = connection.getAutoCommit();
            connection.setAutoCommit(false);
            statement = connection.prepareStatement(FileBasedAnalyticsConstants.INSERT_UPLOADED_FILE_INFO_QUERY);
            ...
            FileBasedAnalyticsDBUtil.closeAllConnections(statement, connection, null);
        }
    }
        ...
        try {
            ...
            if ((connection.getMetaData().getDriverName()).contains("Oracle")) {
                selectStatement = connection
                        .prepareStatement(FileBasedAnalyticsConstants.GET_NEXT_FILES_TO_PROCESS_QUERY_ORACLE);
            } else if (connection.getMetaData().getDatabaseProductName().contains("Microsoft")) {
                selectStatement = connection
                        .prepareStatement(FileBasedAnalyticsConstants.GET_NEXT_FILES_TO_PROCESS_QUERY_MSSQL);
            } else if (connection.getMetaData().getDatabaseProductName().contains("DB2")) {
                selectStatement = connection
                        .prepareStatement(FileBasedAnalyticsConstants.GET_NEXT_FILES_TO_PROCESS_QUERY_DB2);
            } else {
                selectStatement = connection
                        .prepareStatement(FileBasedAnalyticsConstants.GET_NEXT_FILES_TO_PROCESS_QUERY_DEFAULT);
            }
            ...
            while (resultSet.next()) {
                ...
                updateStatement = connection
                        .prepareStatement(FileBasedAnalyticsConstants.UPDATE_FILE_PROCESSING_STARTED_STATUS);
            ...
            FileBasedAnalyticsDBUtil.closeStatement(updateStatement);
            FileBasedAnalyticsDBUtil.closeAllConnections(selectStatement, connection, resultSet);
        }
    ...
    public static void updateCompletion(UploadedFileInfoDTO dto) throws FileBasedAnalyticsException {
        ...
        try {
            connection = FileBasedAnalyticsDBUtil.getConnection();
            connection.setAutoCommit(false);
            statement = connection.prepareStatement(FileBasedAnalyticsConstants.UPDATE_COMPETITION_QUERY);
            statement.setString(1, dto.getTenantDomain());
            statement.setString(2, dto.getFileName());
            statement.executeUpdate();
            connection.commit();
    ...
    public static InputStream getFileContent(UploadedFileInfoDTO dto) throws FileBasedAnalyticsException {
        ...
        try {
            connection = FileBasedAnalyticsDBUtil.getConnection();
            connection.setAutoCommit(false);
            statement = connection.prepareStatement(FileBasedAnalyticsConstants.GET_UPLOADED_FILE_CONTENT_QUERY);
            statement.setString(1, dto.getTenantDomain());
            statement.setString(2, dto.getFileName());
            ...
            while (resultSet.next()) {
                ...
                if (connection.getMetaData().getDriverName().contains("PostgreSQL")) {
                    fileContentInputStream = resultSet
                            .getBinaryStream(FileBasedAnalyticsConstants.API_USAGE_FILE_CONTENT);
                } else {
                    Blob content = resultSet.getBlob(FileBasedAnalyticsConstants.API_USAGE_FILE_CONTENT);
            ...
            FileBasedAnalyticsDBUtil.closeAllConnections(statement, connection, resultSet);
        }
    ...
    public static void deleteProcessedOldFiles(Date lastKeptDate) throws FileBasedAnalyticsException {
        ...
        try {
            ...
            autoCommitStatus = connection.getAutoCommit();
            connection.setAutoCommit(false);
            delStatement = connection.prepareStatement(FileBasedAnalyticsConstants.DELETE_OLD_UPLOAD_COMPLETED_FILES);
            ...
            FileBasedAnalyticsDBUtil.closeAllConnections(delStatement, connection, null);
        }
    }
