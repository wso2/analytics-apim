...
*/
package org.wso2.analytics.apim.siddhi.io.mgwfile;
...
import org.wso2.analytics.apim.siddhi.io.mgwfile.task.MGWFileCleanUpTask;
import org.wso2.analytics.apim.siddhi.io.mgwfile.util.MGWFileSourceDBUtil;
...
public class MGWFileSourceDS {
    ...
    protected void onDataSourceServiceReady(DataSourceService service) {
        try {
            HikariDataSource dsObject = (HikariDataSource) service.getDataSource("APIM_ANALYTICS_DB");
