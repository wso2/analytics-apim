...
/**
 * Table to display resource usage of application
 */
class CustomTable extends React.Component {
    ...
    /**
     * Render the Application Resource Usage table
     * @return {ReactElement} customTable
     */
    render() {
        const { data, classes, inProgress, columns } = this.props;
        const {
        ...
        const menuItems = [
            ...
            <MenuItem value='resource'>
                <FormattedMessage id='table.heading.resource' defaultMessage='RESOURCE' />
            </MenuItem>,
            <MenuItem value='hits'>
        ...
        return (
            <Paper className={classes.root}>
                <CustomTableToolbar
                    ...
                    title='RESOURCE USAGE OF APPLICATION'
                    menuItems={menuItems}
                    data={data}
                    columns={columns}
                />
