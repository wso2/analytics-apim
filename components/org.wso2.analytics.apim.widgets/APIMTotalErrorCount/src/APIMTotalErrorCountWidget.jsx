...
import APIMTotalErrorCount from './APIMTotalErrorCount';
 ...
 * @extends {Widget}
 */
class APIMTotalErrorCountWidget extends Widget {
    /**
     * Creates an instance of APIMTotalErrorCountWidget.
    ...
    loadLocale(locale = 'en') {
        return new Promise((resolve, reject) => {
            Axios
                .get(`${window.contextPath}/public/extensions/widgets/APIMTotalErrorCount/locales/${locale}.json`)
                .then((response) => {
...
global.dashboard.registerWidget('APIMTotalErrorCount', APIMTotalErrorCountWidget);
