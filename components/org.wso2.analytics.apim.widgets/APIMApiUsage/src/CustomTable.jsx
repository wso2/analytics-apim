...
/**
 * Create React Component for Top Api Users Table
 */
class CustomTable extends React.Component {
    ...
    /**
     * Render the Top Api Users table
     * @return {ReactElement} customTable
     */
    render() {
        const {
            data, classes, onClickTableRow, columns, strColumns, title, username, timeTo, timeFrom,
        } = this.props;
        const {
        ...
        const menuItems = [
            <MenuItem value='api'>
                <FormattedMessage id='table.heading.api' defaultMessage='API NAME' />
            </MenuItem>,
