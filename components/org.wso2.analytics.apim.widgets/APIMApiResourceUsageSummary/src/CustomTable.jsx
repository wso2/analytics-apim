...
/**
 * Create React Component for Api Resource Usage Summary Table
 */
class CustomTable extends React.Component {
    ...
    /**
     * Render the Api Resource Usage Summary table
     * @return {ReactElement} customTable
     */
    render() {
        const {
            data, classes, columns, strColumns, title,
        } = this.props;
        const {
        ...
        const menuItems = [
            ...
            <MenuItem value='resourcepath'>
                <FormattedMessage id='table.heading.resourcepath' defaultMessage='RESOURCE PATH' />
            </MenuItem>,
