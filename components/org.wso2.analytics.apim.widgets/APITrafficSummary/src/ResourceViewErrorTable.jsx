...
class APIViewErrorTable extends React.Component {
    ...
    constructor(props) {
        ...
        this.handleErrorSelectChange = this.handleErrorSelectChange.bind(this);
    ...
    render() {
        ...
        const checkBoxData = [
            ...
            },
            {
                ...
                onChange: this.handleErrorSelectChange,
                color: colorScale[0],
            },
        ];
        if (data.length === 0) {
