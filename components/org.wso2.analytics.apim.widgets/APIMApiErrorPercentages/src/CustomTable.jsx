...
class CustomTable extends React.Component {
    ...
    /**
     * Render the Top App Creators table
     * @return {ReactElement} customTable
     */
    render() {
        const { data, classes, timeTo, timeFrom, } = this.props;
        const {
        ...
        const menuItems = [
            <MenuItem value='apiName'>
                <FormattedMessage id='table.heading.api.name' defaultMessage='API NAME' />
            </MenuItem>,
            <MenuItem value='version'>
                <FormattedMessage id='table.heading.version' defaultMessage='VERSION' />
            </MenuItem>,
            <MenuItem value='errorPercentage'>
                <FormattedMessage id='table.heading.error.percentage' defaultMessage='ERROR PERCENTAGE' />
            </MenuItem>,
        ];
        return (
