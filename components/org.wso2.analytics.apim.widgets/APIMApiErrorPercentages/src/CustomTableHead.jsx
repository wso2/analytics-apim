...
const rows = [
    {
        id: 'apiName', numeric: false, disablePadding: false, label: 'table.heading.api.name',
    },
    {
        id: 'version', numeric: false, disablePadding: false, label: 'table.heading.version',
    },
    {
        id: 'errorPercentage', numeric: false, disablePadding: false, label: 'table.heading.error.percentage',
    },
];
