...
/**
 * Create React Component for Api Icon
 * @function ApiIcon
 * @param {object} props - strokeColor, width, height, style
 * @returns {ReactElement} Render the Api Icon
 */
export default function ApiIcon(props) {
    ...
    return (
        ...
        >
            <g
                id='layer2'
                transform='translate(82.262 -41.963)'
            >
                <g
                    id='g5764'
                ...
                >
                    ...
                    />
                    <g
                        transform='matrix(.01024 0 0 .01024 -328.341 48.178)'
                        id='g5762'
                    >
                        <path
