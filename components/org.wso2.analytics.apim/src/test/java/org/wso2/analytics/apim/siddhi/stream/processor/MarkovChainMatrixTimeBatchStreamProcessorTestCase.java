 ...
 */
package org.wso2.analytics.apim.siddhi.stream.processor;
 ...
 * @since Dec 23, 2015
 */
public class MarkovChainMatrixTimeBatchStreamProcessorTestCase {


    private static final Logger log = Logger.getLogger(MarkovChainMatrixTimeBatchStreamProcessorTestCase.class);
...
/*
    ...
    public void uniqueExternalTimeBatchStreamProcessorTest1() throws InterruptedException {
        ...
        String cseEventStream = "" +
                "define stream LoginEvents (consumerKey string, userId string, state string) ;";
        String query = "" +
                "@info(name = 'query1') " +
                "from LoginEvents#markovChainMatrixTimeBatch(consumerKey, userId, state,  5 sec) " +
                "select *  " +
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents, Event[] removeEvents) {
                ...
                if (inEvents != null) {
                    inEventCount++;
                    if (inEventCount == 1) {
                        Assert.assertEquals(4l, inEvents.length);
                    } else if (inEventCount == 2) {
                        Assert.assertEquals(6l, inEvents.length);
                    } 
                    else if (inEventCount == 3) {
                        Assert.assertEquals(4l, inEvents.length);
                    } else if (inEventCount == 4) {
                        Assert.assertEquals(5l, inEvents.length);
                    } 
...
//                    }
        ...
        inputHandler.send(new Object[]{"xyz","admin1@abc","x"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","y"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","y"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","y"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","x"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","x"});
        ...
        Thread.sleep(5000);
        inputHandler.send(new Object[]{"xyz","admin1@abc","z"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","y"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","y"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","y"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","x"});
        ...
        inputHandler.send(new Object[]{"xyz","admin1@abc","x"});
        Thread.sleep(5000);
        inputHandler.send(new Object[]{"abc","admin1@abc","z"});
        inputHandler.send(new Object[]{"abc","admin1@abc","y"});
        inputHandler.send(new Object[]{"abc","admin1@abc","y"});
        inputHandler.send(new Object[]{"abc","admin1@abc","y"});
        inputHandler.send(new Object[]{"abc","admin1@abc","x"});
        inputHandler.send(new Object[]{"abc","admin1@abc","x"});
        inputHandler.send(new Object[]{"abc","admin1@abc","x"});
        Thread.sleep(5000);
        inputHandler.send(new Object[]{"abc","admin@abc","l"});
        inputHandler.send(new Object[]{"abc","admin@abc","y"});
        inputHandler.send(new Object[]{"abc","admin@abc","y"});
        inputHandler.send(new Object[]{"abc","admin@abc","y"});
        inputHandler.send(new Object[]{"abc","admin@abc","x"});
        inputHandler.send(new Object[]{"abc","admin@abc","x"});
        inputHandler.send(new Object[]{"abc","admin@abc","x"});
...
//        inputHandler.send(new Object[]{System.currentTimeMillis(), "192.10.1.6"});
//
...
//        Thread.sleep(5000);
//        inputHandler.send(new Object[]{System.currentTimeMillis(), "192.10.1.6"});
//        inputHandler.send(new Object[]{System.currentTimeMillis(), "192.10.1.8"});
        Thread.sleep(10000);
//        Thread.sleep(2100);
...
//        Thread.sleep(3000);
 ...
 /*   @Test
    public void uniqueExternalTimeBatchStreamProcessorTest2() throws InterruptedException {
        log.info("uniqueExternalTimeBatchStreamProcessorTest test2");

        SiddhiManager siddhiManager = new SiddhiManager();

        String cseEventStream = "" +
                "define stream LoginEvents (consumerKey string, userId string, state string, app string) ;";
        String query = "" +
                "@info(name = 'query1') " +
                "from LoginEvents#amAnalytics.buildTransitions(consumerKey, userId, state, app, 1000) " +
                "select *  " +
                "insert into uniqueIps ;";
...
for(int i=0;i<1000000;i++) {
        inputHandler.send(new Object[]{"xyz","admin1@abc","x", "app1"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","y", "app1"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","y", "app1"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","y", "app1"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","x", "app1"});
        inputHandler.send(new Object[]{"xyz","admin1@abc","x", "app1"});
