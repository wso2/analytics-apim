...
import APIMAppCreated from './APIMAppCreated';
...
/**
 * Create React Component for APIM App Created
 * @class APIMAppCreatedWidget
 * @extends {Widget}
 */
class APIMAppCreatedWidget extends Widget {
    /**
     * Creates an instance of APIMAppCreatedWidget.
    ...
    /**
     * @inheritDoc
     * @returns {ReactElement} Render the APIM App Created widget
     * @memberof APIMAppCreatedWidget
     */
    render() {
        const {
        ...
        const appCreatedProps = { themeName, totalCount, weekCount };
                            ...
                            >
                                ...
                                <Typography component='p'>
                                    <FormattedMessage
                                        ...
                                        defaultMessage='Cannot fetch provider configuration for APIM App Created widget'
                                    />
                                </Typography>
                            </Paper>
                        </div>
                    ) : (
                        <APIMAppCreated {...appCreatedProps} />
                    )
                }
            </IntlProvider>
        );
...
global.dashboard.registerWidget('APIMAppCreated', APIMAppCreatedWidget);
