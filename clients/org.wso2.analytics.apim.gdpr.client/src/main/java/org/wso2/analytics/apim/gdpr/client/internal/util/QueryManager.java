...
public class QueryManager {
    ...
    public QueryManager(String databaseType, String databaseVersion, List<Queries> deploymentQueries)
    ...
    public Map<String, String> readConfigs(String databaseType, String databaseVersion)
        ...
        try {
            ...
            if (url != null) {
                GDPRClientConfiguration gdprClientConfiguration = readYamlContent(url.openStream());
                componentQueries = gdprClientConfiguration.getQueries();
            } else {
    ...
    private GDPRClientConfiguration readYamlContent(InputStream yamlContent) {
        Yaml yaml = new Yaml(new CustomClassLoaderConstructor(GDPRClientConfiguration.class,
                GDPRClientConfiguration.class.getClassLoader()));
        yaml.setBeanAccess(BeanAccess.FIELD);
        return yaml.loadAs(yamlContent, GDPRClientConfiguration.class);
    }
}
